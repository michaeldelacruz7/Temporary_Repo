...
public class CommandWrapperBuilder {
    ...
    public CommandWrapperBuilder updateCreditScore(final int creditScoreId) {
        ...
        this.entityId = new Long(creditScoreId);
        this.href = "/scoremanager/template";
        this.creditScoreId = creditScoreId;
        return this;
    }
    
    public CommandWrapperBuilder updateCreditScoreStatus(final int creditScoreId) {
        this.actionName = "UPDATE";
        this.entityName = "CREDIT_SCORE_STATUS";
        this.entityId = new Long(creditScoreId);
        this.href = "/scoremanager/template";
        this.creditScoreId = creditScoreId;
        return this;
    ...
    public CommandWrapperBuilder createCreditScore() {
        this.actionName = "CREATE";
        this.entityName = "CREDIT_SCORE";
        this.href = "/scoremanager/template";
        return this;
