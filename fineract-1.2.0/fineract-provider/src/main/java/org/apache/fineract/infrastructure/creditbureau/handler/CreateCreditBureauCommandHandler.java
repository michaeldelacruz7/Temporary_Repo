...
public class CreateCreditBureauCommandHandler implements NewCommandSourceHandler {

	private final OrganisationCreditBureauWritePlatflormService writePlatformService;

	@Autowired
	public CreateCreditBureauCommandHandler(final OrganisationCreditBureauWritePlatflormService writePlatformService) {
