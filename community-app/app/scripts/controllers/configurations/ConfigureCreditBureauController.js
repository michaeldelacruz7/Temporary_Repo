(function (module) {
    mifosX.controllers = _.extend(module, {
        ConfigureCreditBureauController: function ($scope, http,API_VERSION,$rootScope,resourceFactory,dateFilter, $routeParams, location) {
            $scope.formData = {};
            $scope.creditbureaus=[];
            ...
            $scope.submit = function () {
                ...
                resourceFactory.configOrgCreditBureau.save({ocbId: $scope.creditBureauId},$scope.formData,function (data) {
    ...
    mifosX.ng.application.controller('ConfigureCreditBureauController', ['$scope','$http','API_VERSION','$rootScope', 'ResourceFactory', 'dateFilter','$routeParams', '$location', mifosX.controllers.ConfigureCreditBureauController]).run(function ($log) {
        $log.info("ConfigureCreditBureauController initialized");
    });
}(mifosX.controllers || {}));